...
export interface ApiAvailabilityAvailability extends Schema.SingleType {
  ...
  attributes: {
    AvailabilityEmail: Attribute.String;
    AvailabilityText: Attribute.String;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPropositionProposition extends Schema.SingleType {
...
export interface ApiSiteSettingSiteSetting extends Schema.SingleType {
  ...
  attributes: {
    ...
    socialLink: Attribute.Component<'project.link', true>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::site-setting.site-setting',
      'oneToOne',
...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    Agency: Attribute.Relation<
      ...
      'api::agency.agency'
    >;
    Awards: Attribute.String;
    Client: Attribute.String;
    Confidential: Attribute.Boolean;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::work.work', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    Credit: Attribute.Component<'project.credit', true>;
    ExternalLink: Attribute.Component<'project.link'>;
    HeroMedia: Attribute.Media<'images' | 'files' | 'videos'>;
    Industry: Attribute.Enumeration<['Fintech', 'Health', 'Retail']>;
    IntroSection: Attribute.Component<'project.section', true>;
    Phone: Attribute.Component<'project.content-section-phones'>;
    ...
    ThumbImage: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
